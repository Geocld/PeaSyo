...
const buttonBlurColor = '#fff';
const buttonFocusColor = '#DF6069';
const strokeWidth = 4;
...
const DS5Controller = ({
  ...
  return (
    <View style={{width: '100%', height: 350}}>
      <Svg width="100%" height="100%" viewBox="0 0 1117 892">
        <Path
          d="M917.682,411.683l32.795,32.795m-0,-32.795l-32.795,32.795"
          fill="#fff"
          stroke={strokeColor}
        ...
        />
        <Path
          d="M934.079,271.403l20.206,33.355l-40.411,-0l20.205,-33.355Z"
          fill="#fff"
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        ...
        <Path
          ...
          fill={rightTrigger ? buttonFocusColor : buttonBlurColor}
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        <Path
          ...
          fill={leftTrigger ? buttonFocusColor : buttonBlurColor}
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        ...
        <G id="dpad-up">
          <Path
            ...
            fill={up ? buttonFocusColor : buttonBlurColor}
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
          <Path
            d="M168.337,270.016l18.658,0l-9.081,-9.08l-9.577,9.08Z"
            fill={strokeColor}
          />
        </G>
        ...
        <G id="dpad-down">
          <Path
            ...
            fill={down ? buttonFocusColor : buttonBlurColor}
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
          <Path
            d="M168.337,445.073l18.658,0l-9.081,9.08l-9.577,-9.08Z"
            fill={strokeColor}
          />
        </G>
        ...
        <G id="dpad-right">
          <Path
            ...
            fill={right ? buttonFocusColor : buttonBlurColor}
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
          <Path
            d="M265.73,367.409l0,-18.657l9.081,9.08l-9.081,9.577Z"
            fill={strokeColor}
          />
        </G>
        ...
        <G id="dpad-left">
          <Path
            ...
            fill={left ? buttonFocusColor : buttonBlurColor}
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
          <Path
            d="M91.745,367.409l0,-18.657l-9.08,9.08l9.08,9.577Z"
            fill={strokeColor}
          />
        </G>
        ...
        <Circle
          ...
          cy="428.08"
          r="34.957"
          fill={cross ? buttonFocusColor : buttonBlurColor}
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        <Circle
          ...
          cy="358.08"
          r="34.957"
          fill={box ? buttonFocusColor : buttonBlurColor}
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        <Circle
          ...
          cy="358.08"
          r="34.957"
          fill={moon ? buttonFocusColor : buttonBlurColor}
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        <Circle
          ...
          cy="288.08"
          r="34.957"
          fill={pyramid ? buttonFocusColor : buttonBlurColor}
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        ...
        <Path
          id="border2"
          d="M282.527,168.559c13.841,1.794 27.682,-1.16 41.522,-6.511"
          fill="none"
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        ...
        <Path
          ...
          fill={mute ? buttonFocusColor : buttonBlurColor}
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        ...
        <Path
          id="border3"
          d="M835.33,168.559c-13.84,1.794 -27.681,-1.16 -41.522,-6.511"
          fill="none"
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        ...
        <G>
          <Path
            ...
            fill={
              touchpad || touch0active || touch1active
                ? buttonFocusColor
                : 'none'
            }
            stroke={strokeColor}
        ...
        <Path
          ...
          fill={options ? buttonFocusColor : 'none'}
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        ...
        <Path
          ...
          fill={share ? buttonFocusColor : 'none'}
          stroke={strokeColor}
          strokeWidth={strokeWidth}
        />
        ...
        <G id="create-icon">
          <Path
            d="M262.694,188.058l-4.528,-7.079l4.528,7.079Z"
            fill="none"
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
          <Path
            d="M269.717,185.341l-0,-8.725l-0,8.725Z"
            fill="none"
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
          <Path
            d="M275.535,188.058l5.186,-7.079"
            fill="none"
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
        ...
        <G id="options-icon">
          <Path
            d="M856.893,174.616l-13.987,0l13.987,0Z"
            fill="none"
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
          <Path
            d="M856.893,180.337l-13.987,0l13.987,0Z"
            fill="none"
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
          <Path
            d="M856.893,186.058l-13.987,-0"
            fill="none"
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
        ...
        <G id="r3group">
          ...
          <Circle
            ...
            cy="528.548"
            r="57.193"
            fill={r3 ? buttonFocusColor : buttonBlurColor}
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
        </G>
        ...
        <G id="l3group">
          ...
          <Circle
            ...
            cy="528.548"
            r="57.193"
            fill={l3 ? buttonFocusColor : buttonBlurColor}
            stroke={strokeColor}
            strokeWidth={strokeWidth}
          />
        </G>
        ...
        <Path
          ...
          fill={ps ? buttonFocusColor : buttonBlurColor}
          fillRule="nonzero"
        />
      </Svg>
    </View>
