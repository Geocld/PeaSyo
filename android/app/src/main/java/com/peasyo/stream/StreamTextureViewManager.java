...
public class StreamTextureViewManager extends SimpleViewManager<StreamTextureView> {
    public static final String REACT_CLASS = "StreamTextureView";
    ...
    @Override
    @NonNull
    protected StreamTextureView createViewInstance(@NonNull ThemedReactContext reactContext) {
        return new StreamTextureView(reactContext);
    }
